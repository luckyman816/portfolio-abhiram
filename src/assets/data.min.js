const identity = { name: "John Chia", image: "Profile-pic" };
const data = {
	NavBar: {
		...identity,
		links: [
	...
	Home: {
		introduction:
			"I am a 2021 pass out Graduates of Bachelor of Technology in Computer Science Engineering from Middlesex University",
		resumeLink: "",
		typedElement: [
			"John Chia",
	...
	About: {
		...
		about: {
			"tech-stats":
				"FullStack Web Developer, Data Science, Web3 development",
			bio: " ",
			"IDE, Editors & Tools": [
				"Intellij",
				"PyCharm",
		...
		education: [
			...
			},
			{
				...
				textAlignment: "left",
				degree: "Master of Business, Administration(MBA), Human Resource Management",
				college: "Charles Sturt University",
				duration: "2016 - 2017",
	...
	Portfolio: [
		...
		},
		{
			...
			description:
				"Created chatbot base on MERN stack by using open ai api key",
			placement: "bottom",
		...
		},
		{
			...
			project: "e-shop",
			description:
				"I have build website using Laravel Bagisto",
			placement: "bottom",
			github: "e-shop"
		},
		{
	...
	Contact: [
		...
		},
		{
			...
			links: [
				{ type: "Whatsapp", title: "+62 (822) 606-82705" },
			],
		},
		{
			animationClass: "Right",
			...
			links: [{ type: "mailto:", title: "smart163410@gmail.com" }, { type: "mailto:", title: "Skype Address(Lucky Angel)  live:.cid.b9f0dadc04892502" },],
		},
	],
	Social: [
		[
